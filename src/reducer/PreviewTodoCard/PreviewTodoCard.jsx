...
const PreviewTodoCard = ({todo}) => {
    const {dispatch} = useContext(TodoContext);    const handleDeleteTodoList = (id) => {
  ...
  return (
      <div className={'PreviewTodoCard'} >
          <Button variant="danger" className={'deleteButton'} onClick={() => handleDeleteTodoList(todo.id)}>
              <img src="https://img.icons8.com/material-outlined/24/000000/delete-property.png" alt={'deleteTodoList'}/>
          </Button>
          <Card border="info" style={{ width: '18rem' ,height:'10rem',margin:'10px',backgroundColor:'rgba(130, 182, 154, 0.2)'}}>
